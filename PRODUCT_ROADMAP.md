...
| Next acceptance | `LCP-01` — prove the complete Windows Provider lifecycle on the exact packaged candidate |
...
| Pause reason | None. |
| Current verdict | macOS：`qilin`、`vectorengine`、`DeepSeek` 与 OpenAI 官方登录的往返切换均已完成真机复验；本行取代上方候选说明中的过期“Remaining”条目。 |
...
| Current verdict | `LCP-05 PASS` and `LCP-06 PASS`: final app source candidate is commit `4dc32b7d98066c172d82a7486a1290d1adaeea90`; Mac DMG and Windows EXE/ZIP are built and smoke-tested. Release boundary is `INTERNAL_CANDIDATE`; `v0.1 Beta` remains blocked until `LCP-01` and `LCP-02` full lifecycle evidence is proven. |
