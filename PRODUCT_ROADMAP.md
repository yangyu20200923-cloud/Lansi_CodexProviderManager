...
| Lifecycle | `VERIFY` |
| Current Phase | `P2` — cross-platform parity and preservation |
| Current acceptance | `LCP-04` / `VERIFY` |
| Next Phase | `P2` — cross-platform parity and preservation |
| Next acceptance | `LCP-04` — prove preservation and recovery without mutating protected roots |
